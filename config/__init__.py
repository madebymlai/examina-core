...
class Config:
    ...
    TRANSLATION_DETECTION_ENABLED = os.getenv("EXAMINA_TRANSLATION_ENABLED", "true").lower() == "true"
    TRANSLATION_DETECTION_THRESHOLD = float(os.getenv("EXAMINA_TRANSLATION_THRESHOLD", "0.70"))
    PREFERRED_LANGUAGES = ["english", "en"]

    # Language Detection Settings
    LANGUAGE_DETECTION_ENABLED = os.getenv("EXAMINA_LANGUAGE_DETECTION_ENABLED", "true").lower() == "true"
    ...
    LEARNING_MATERIALS_ENABLED = os.getenv("EXAMINA_LEARNING_MATERIALS_ENABLED", "true").lower() == "true"
    SHOW_THEORY_BY_DEFAULT = os.getenv("EXAMINA_SHOW_THEORY", "true").lower() == "true"
    SHOW_WORKED_EXAMPLES_BY_DEFAULT = os.getenv("EXAMINA_SHOW_WORKED_EXAMPLES", "true").lower() == "true"
    ...
    MATERIAL_TOPIC_SIMILARITY_THRESHOLD = float(os.getenv("EXAMINA_MATERIAL_TOPIC_THRESHOLD", "0.85"))
    WORKED_EXAMPLE_EXERCISE_SIMILARITY_THRESHOLD = float(os.getenv("EXAMINA_WORKED_EXAMPLE_THRESHOLD", "0.70"))
